...
if not SECRET_KEY:
    if DEBUG:
        ...
        raise RuntimeError("SECRET_KEY is required when DEBUG=0")
...
ROOT_URLCONF = "clinicaltrack.urls"
TEMPLATES = [{
...
WSGI_APPLICATION = "clinicaltrack.wsgi.application"

DATABASES = {
    "default": dj_database_url.config(
        default=f"sqlite:///{BASE_DIR / 'clinicaltrack.db'}",
        conn_max_age=60,
...
DEMO_ACCOUNTS = [('manager.demo', 'Gestor'), ('supervisor.demo', 'Supervisor'), ('trainee.demo', 'Trainee')]
